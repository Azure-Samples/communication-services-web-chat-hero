    ...
    public class InMemoryChatAdminThreadStore : IChatAdminThreadStore
    {
        ...
        private void initializeHardCodedValues()
        {
            var eventInfo = new ACSEvent
            {
                ...
                {
                    ThreadId = "19:EV6bzyGuXSRPBmp2bo4BHlbjsfyLLtFOkB8KjZiHb201@thread.v2",
                    ThreadModeratorId = "8:acs:85c99b9e-f6e1-408c-90d9-e37b6ad0e7c3_0000000a-baee-fdc5-28c5-593a0d000c27",
                },
